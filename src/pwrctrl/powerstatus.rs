...
#[doc = "Writer for register POWERSTATUS"]
pub type W = crate::W<u32, super::POWERSTATUS>;
#[doc = "Register POWERSTATUS `reset()`'s with value 0"]
impl crate::ResetValue for super::POWERSTATUS {
    type Type = u32;
    #[inline(always)]
