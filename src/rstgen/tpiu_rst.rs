#[doc = "Reader of register TPIU_RST"]
pub type R = crate::R<u32, super::TPIU_RST>;
#[doc = "Writer for register TPIU_RST"]
pub type W = crate::W<u32, super::TPIU_RST>;
#[doc = "Register TPIU_RST `reset()`'s with value 0"]
impl crate::ResetValue for super::TPIU_RST {
    type Type = u32;
    #[inline(always)]
