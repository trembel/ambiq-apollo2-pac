...
#[repr(u32)]
pub enum VALUE_A {
    #[doc = "0: Apollo2 CHIPID1. The upper 32-bits of the 64-bit CHIPID value, which is unique for each part."]
    APOLLO2 = 0,
}
...
impl<'a> VALUE_W<'a> {
    ...
    #[doc = "Apollo2 CHIPID1. The upper 32-bits of the 64-bit CHIPID value, which is unique for each part."]
    #[inline(always)]
    pub fn apollo2(self) -> &'a mut W {
        self.variant(VALUE_A::APOLLO2)
    }
