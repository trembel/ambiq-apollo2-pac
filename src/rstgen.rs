...
#[doc = "Clear the status register"]
pub mod clrstat;
#[doc = "TPIU reset\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tpiu_rst](tpiu_rst) module"]
pub type TPIU_RST = crate::Reg<u32, _TPIU_RST>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TPIU_RST;
#[doc = "`read()` method returns [tpiu_rst::R](tpiu_rst::R) reader structure"]
impl crate::Readable for TPIU_RST {}
#[doc = "`write(|w| ..)` method takes [tpiu_rst::W](tpiu_rst::W) writer structure"]
impl crate::Writable for TPIU_RST {}
#[doc = "TPIU reset"]
pub mod tpiu_rst;
