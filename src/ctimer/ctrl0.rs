...
pub enum TMRB0CLK_A {
    ...
    HCLK = 15,
    #[doc = "16: Clock source is buck converter stream from CORE Buck."]
    BUCKB = 16,
}
...
impl<'a> TMRB0CLK_W<'a> {
    ...
    #[doc = "Clock source is buck converter stream from CORE Buck."]
    #[inline(always)]
...
pub enum TMRA0PE_A {
    ...
    DIS = 0,
    #[doc = "1: Enable counter/timer A0 to generate a signal on TMRPINA."]
    EN = 1,
}
...
impl<'a> TMRA0PE_W<'a> {
    ...
    #[doc = "Enable counter/timer A0 to generate a signal on TMRPINA."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum TMRA0CLK_A {
    ...
    #[doc = "14: Clock source is 100 Hz from the current RTC oscillator."]
    RTC_100HZ = 14,
    #[doc = "15: Clock source is HCLK / 4."]
    HCLK_DIV4 = 15,
    #[doc = "16: Clock source is buck converter stream from MEM Buck."]
    BUCKA = 16,
}
...
impl<'a> TMRA0CLK_W<'a> {
    ...
    #[doc = "Clock source is HCLK / 4."]
    #[inline(always)]
    pub fn hclk_div4(self) -> &'a mut W {
        self.variant(TMRA0CLK_A::HCLK_DIV4)
    }
    #[doc = "Clock source is buck converter stream from MEM Buck."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 29 - Counter/Timer B0 Output Enable bit."]
    #[inline(always)]
    pub fn tmrb0pe(&self) -> TMRB0PE_R {
        TMRB0PE_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 13 - Counter/Timer A0 Output Enable bit."]
    #[inline(always)]
    pub fn tmra0pe(&self) -> TMRA0PE_R {
        TMRA0PE_R::new(((self.bits >> 13) & 0x01) != 0)
    }
