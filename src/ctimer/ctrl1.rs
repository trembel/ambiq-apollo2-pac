...
impl R {
    ...
    #[doc = "Bit 29 - Counter/Timer B1 Output Enable bit."]
    #[inline(always)]
    pub fn tmrb1pe(&self) -> TMRB1PE_R {
        TMRB1PE_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 13 - Counter/Timer A1 Output Enable bit."]
    #[inline(always)]
    pub fn tmra1pe(&self) -> TMRA1PE_R {
        TMRA1PE_R::new(((self.bits >> 13) & 0x01) != 0)
    }
