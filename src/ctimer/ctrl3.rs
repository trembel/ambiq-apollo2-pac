...
impl R {
    ...
    #[doc = "Bit 29 - Counter/Timer B3 Output Enable bit."]
    #[inline(always)]
    pub fn tmrb3pe(&self) -> TMRB3PE_R {
        TMRB3PE_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 13 - Counter/Timer A3 Output Enable bit."]
    #[inline(always)]
    pub fn tmra3pe(&self) -> TMRA3PE_R {
        TMRA3PE_R::new(((self.bits >> 13) & 0x01) != 0)
    }
