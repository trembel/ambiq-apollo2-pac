...
impl R {
    ...
    #[doc = "Bit 29 - Counter/Timer B2 Output Enable bit."]
    #[inline(always)]
    pub fn tmrb2pe(&self) -> TMRB2PE_R {
        TMRB2PE_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 13 - Counter/Timer A2 Output Enable bit."]
    #[inline(always)]
    pub fn tmra2pe(&self) -> TMRA2PE_R {
        TMRA2PE_R::new(((self.bits >> 13) & 0x01) != 0)
    }
