#[doc = "Reader of register FRD"]
pub type R = crate::R<u32, super::FRD>;
#[doc = "Writer for register FRD"]
pub type W = crate::W<u32, super::FRD>;
#[doc = "Register FRD `reset()`'s with value 0"]
impl crate::ResetValue for super::FRD {
    type Type = u32;
    #[inline(always)]
