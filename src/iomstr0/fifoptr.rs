...
impl R {
    #[doc = "Bits 16:23 - The number of bytes remaining in the FIFO (i.e. 128-FIFOSIZ if FULLDUP = 0 or 64-FIFOSIZ if FULLDUP = 1))."]
    #[inline(always)]
    pub fn fiforem(&self) -> FIFOREM_R {
        FIFOREM_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 0:7 - The number of bytes currently in the FIFO."]
    #[inline(always)]
    pub fn fifosiz(&self) -> FIFOSIZ_R {
        FIFOSIZ_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 16:23 - The number of bytes remaining in the FIFO (i.e. 128-FIFOSIZ if FULLDUP = 0 or 64-FIFOSIZ if FULLDUP = 1))."]
