...
#[repr(u8)]
pub enum FSEL_A {
    #[doc = "0: Selects the minimum power clock.  This setting should be used whenever the IOMSTR is not active."]
    MIN_PWR = 0,
...
impl<'a> FSEL_W<'a> {
    ...
    #[doc = "Selects the minimum power clock. This setting should be used whenever the IOMSTR is not active."]
    #[inline(always)]
