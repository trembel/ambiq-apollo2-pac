...
#[doc = "Slot 7 Configuration Register"]
pub mod sl7cfg;
#[doc = "Window Comparator Upper Limits Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wulim](wulim) module"]
pub type WULIM = crate::Reg<u32, _WULIM>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _WULIM;
#[doc = "`read()` method returns [wulim::R](wulim::R) reader structure"]
impl crate::Readable for WULIM {}
#[doc = "`write(|w| ..)` method takes [wulim::W](wulim::W) writer structure"]
impl crate::Writable for WULIM {}
#[doc = "Window Comparator Upper Limits Register"]
pub mod wulim;
#[doc = "Window Comparator Lower Limits Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wllim](wllim) module"]
pub type WLLIM = crate::Reg<u32, _WLLIM>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _WLLIM;
#[doc = "`read()` method returns [wllim::R](wllim::R) reader structure"]
impl crate::Readable for WLLIM {}
#[doc = "`write(|w| ..)` method takes [wllim::W](wllim::W) writer structure"]
impl crate::Writable for WLLIM {}
#[doc = "Window Comparator Lower Limits Register"]
pub mod wllim;
