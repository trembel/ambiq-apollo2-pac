...
pub enum PAD19FNCSEL_A {
    ...
    UART1RX = 6,
    #[doc = "7: Configure as the I2S Byte clock input signal"]
    I2S_BCLK = 7,
}
...
impl<'a> PAD19FNCSEL_W<'a> {
    ...
    pub fn tcta1(self) -> &'a mut W {
        self.variant(PAD19FNCSEL_A::TCTA1)
    }
    ...
    pub fn i2s_bclk(self) -> &'a mut W {
        self.variant(PAD19FNCSEL_A::I2S_BCLK)
    }
...
pub enum PAD18FNCSEL_A {
    ...
    GPIO18 = 3,
    #[doc = "4: Configure as the SPI nCE channel 1 from IOMSTR4"]
    M4NCE1 = 4,
    #[doc = "5: Configure as ANATEST2 I/O signal"]
    ANATEST2 = 5,
    #[doc = "6: Configure as UART1 TX output signal"]
    UART1TX = 6,
    #[doc = "7: Configure as the 32kHz output clock from the crystal"]
    _32KHZ_XT = 7,
}
...
impl PAD18FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD18FNCSEL_A {
        match self.bits {
            ...
            4 => PAD18FNCSEL_A::M4NCE1,
            5 => PAD18FNCSEL_A::ANATEST2,
            6 => PAD18FNCSEL_A::UART1TX,
            7 => PAD18FNCSEL_A::_32KHZ_XT,
            _ => unreachable!(),
        }
    }
...
impl<'a> PAD18FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the SPI nCE channel 1 from IOMSTR4"]
    #[inline(always)]
    pub fn m4n_ce1(self) -> &'a mut W {
        self.variant(PAD18FNCSEL_A::M4NCE1)
    }
    ...
    pub fn _32khz_xt(self) -> &'a mut W {
        self.variant(PAD18FNCSEL_A::_32KHZ_XT)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
pub enum PAD17FNCSEL_A {
    ...
    M4NCE3 = 4,
    #[doc = "5: Configure as external LFRC oscillator input"]
    EXTLF = 5,
...
impl PAD17FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD17FNCSEL_A {
        match self.bits {
            0 => PAD17FNCSEL_A::CMPRF1,
            1 => PAD17FNCSEL_A::M0NCE1,
            2 => PAD17FNCSEL_A::TRIG1,
            3 => PAD17FNCSEL_A::GPIO17,
            4 => PAD17FNCSEL_A::M4NCE3,
            5 => PAD17FNCSEL_A::EXTLF,
            6 => PAD17FNCSEL_A::UART0RX,
            7 => PAD17FNCSEL_A::UA1CTS,
            _ => unreachable!(),
        }
    }
...
impl<'a> PAD17FNCSEL_W<'a> {
    ...
    pub fn m4n_ce3(self) -> &'a mut W {
        self.variant(PAD17FNCSEL_A::M4NCE3)
    }
    #[doc = "Configure as external LFRC oscillator input"]
    #[inline(always)]
...
pub enum PAD16FNCSEL_A {
    ...
    GPIO16 = 3,
    #[doc = "4: Configure as SPI channel 3 nCE for IOMSTR2"]
    M2NCE3 = 4,
...
impl<'a> PAD16FNCSEL_W<'a> {
    ...
    #[doc = "Configure as SPI channel 3 nCE for IOMSTR2"]
    #[inline(always)]
    pub fn m2n_ce3(self) -> &'a mut W {
        self.variant(PAD16FNCSEL_A::M2NCE3)
    }
