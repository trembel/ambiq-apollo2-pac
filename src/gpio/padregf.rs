...
pub enum PAD23FNCSEL_A {
    ...
    GPIO23 = 3,
    #[doc = "4: Configure as PDM Data input to the PDM module"]
    PDM_DATA = 4,
...
impl PAD23FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD23FNCSEL_A {
        match self.bits {
            ...
            4 => PAD23FNCSEL_A::PDM_DATA,
            5 => PAD23FNCSEL_A::CMPOUT,
            6 => PAD23FNCSEL_A::TCTB1,
            7 => PAD23FNCSEL_A::UNDEF7,
            _ => unreachable!(),
        }
    }
...
impl<'a> PAD23FNCSEL_W<'a> {
    ...
    #[doc = "Configure as PDM Data input to the PDM module"]
    #[inline(always)]
    pub fn pdm_data(self) -> &'a mut W {
        self.variant(PAD23FNCSEL_A::PDM_DATA)
    }
    ...
    pub fn tctb1(self) -> &'a mut W {
        self.variant(PAD23FNCSEL_A::TCTB1)
    }
    #[doc = "Undefined/should not be used"]
    #[inline(always)]
    pub fn undef7(self) -> &'a mut W {
        self.variant(PAD23FNCSEL_A::UNDEF7)
    }
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PAD22PWRUP_A {
    #[doc = "0: Power switch disabled"]
    DIS = 0,
    #[doc = "1: Power switch enabled"]
    EN = 1,
}
impl From<PAD22PWRUP_A> for bool {
    #[inline(always)]
    fn from(variant: PAD22PWRUP_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PAD22PWRUP`"]
pub type PAD22PWRUP_R = crate::R<bool, PAD22PWRUP_A>;
impl PAD22PWRUP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD22PWRUP_A {
        match self.bits {
            false => PAD22PWRUP_A::DIS,
            true => PAD22PWRUP_A::EN,
        }
    }
    #[doc = "Checks if the value of the field is `DIS`"]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == PAD22PWRUP_A::DIS
    }
    #[doc = "Checks if the value of the field is `EN`"]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == PAD22PWRUP_A::EN
    }
}
#[doc = "Write proxy for field `PAD22PWRUP`"]
pub struct PAD22PWRUP_W<'a> {
    w: &'a mut W,
}
impl<'a> PAD22PWRUP_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PAD22PWRUP_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(PAD22PWRUP_A::DIS)
    }
    #[doc = "Power switch enabled"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PAD22PWRUP_A::EN)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub enum PAD22FNCSEL_A {
    ...
    PDM_CLK = 4,
    #[doc = "5: Undefined/should not be used"]
    UNDEF5 = 5,
    #[doc = "6: Configure as the input/output signal from CTIMER B1"]
    TCTB1 = 6,
...
impl PAD22FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD22FNCSEL_A {
        match self.bits {
            ...
            5 => PAD22FNCSEL_A::UNDEF5,
            6 => PAD22FNCSEL_A::TCTB1,
            7 => PAD22FNCSEL_A::SWO,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `UNDEF5`"]
    #[inline(always)]
    pub fn is_undef5(&self) -> bool {
        *self == PAD22FNCSEL_A::UNDEF5
    }
    #[doc = "Checks if the value of the field is `TCTB1`"]
    #[inline(always)]
    pub fn is_tctb1(&self) -> bool {
        *self == PAD22FNCSEL_A::TCTB1
    }
...
impl<'a> PAD22FNCSEL_W<'a> {
    ...
    #[doc = "Undefined/should not be used"]
    #[inline(always)]
    pub fn undef5(self) -> &'a mut W {
        self.variant(PAD22FNCSEL_A::UNDEF5)
    }
    #[doc = "Configure as the input/output signal from CTIMER B1"]
    #[inline(always)]
    pub fn tctb1(self) -> &'a mut W {
        self.variant(PAD22FNCSEL_A::TCTB1)
    }
...
impl PAD21FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD21FNCSEL_A {
        match self.bits {
            ...
            4 => PAD21FNCSEL_A::UART0RX,
            5 => PAD21FNCSEL_A::UART1RX,
            6 => PAD21FNCSEL_A::UNDEF6,
            7 => PAD21FNCSEL_A::UNDEF7,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_undef6(&self) -> bool {
        *self == PAD21FNCSEL_A::UNDEF6
    }
    #[doc = "Checks if the value of the field is `UNDEF7`"]
    #[inline(always)]
    pub fn is_undef7(&self) -> bool {
        *self == PAD21FNCSEL_A::UNDEF7
    }
}
...
impl<'a> PAD21FNCSEL_W<'a> {
    ...
    pub fn undef6(self) -> &'a mut W {
        self.variant(PAD21FNCSEL_A::UNDEF6)
    }
    #[doc = "Undefined/should not be used"]
    #[inline(always)]
    pub fn undef7(self) -> &'a mut W {
        self.variant(PAD21FNCSEL_A::UNDEF7)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
impl PAD20FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD20FNCSEL_A {
        match self.bits {
            ...
            4 => PAD20FNCSEL_A::UART0TX,
            5 => PAD20FNCSEL_A::UART1TX,
            6 => PAD20FNCSEL_A::UNDEF6,
            7 => PAD20FNCSEL_A::UNDEF7,
            _ => unreachable!(),
        }
    }
    ...
    #[inline(always)]
    pub fn is_undef6(&self) -> bool {
        *self == PAD20FNCSEL_A::UNDEF6
    }
    #[doc = "Checks if the value of the field is `UNDEF7`"]
    #[inline(always)]
    pub fn is_undef7(&self) -> bool {
        *self == PAD20FNCSEL_A::UNDEF7
    }
}
...
impl<'a> PAD20FNCSEL_W<'a> {
    ...
    #[inline(always)]
    pub fn undef6(self) -> &'a mut W {
        self.variant(PAD20FNCSEL_A::UNDEF6)
    }
    #[doc = "Undefined/should not be used"]
    #[inline(always)]
    pub fn undef7(self) -> &'a mut W {
        self.variant(PAD20FNCSEL_A::UNDEF7)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 23 - Pad 22 upper power switch enable"]
    #[inline(always)]
    pub fn pad22pwrup(&self) -> PAD22PWRUP_R {
        PAD22PWRUP_R::new(((self.bits >> 23) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 23 - Pad 22 upper power switch enable"]
    #[inline(always)]
    pub fn pad22pwrup(&mut self) -> PAD22PWRUP_W {
        PAD22PWRUP_W { w: self }
    }
    #[doc = "Bits 19:21 - Pad 22 function select"]
    #[inline(always)]
