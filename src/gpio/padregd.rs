...
pub enum PAD15FNCSEL_A {
    ...
    GPIO15 = 3,
    #[doc = "4: Configure as the SPI Channel 2 nCE signal from IOMSTR2"]
    M2NCE2 = 4,
...
impl<'a> PAD15FNCSEL_W<'a> {
    ...
    pub fn m2n_ce2(self) -> &'a mut W {
        self.variant(PAD15FNCSEL_A::M2NCE2)
    }
...
pub enum PAD14FNCSEL_A {
    ...
    GPIO14 = 3,
    #[doc = "4: Configure as the SPI channel 1 nCE signal from IOMSTR2"]
    M2NCE1 = 4,
...
impl<'a> PAD14FNCSEL_W<'a> {
    ...
    pub fn m2n_ce1(self) -> &'a mut W {
        self.variant(PAD14FNCSEL_A::M2NCE1)
    }
    ...
    pub fn _32khz_xt(self) -> &'a mut W {
        self.variant(PAD14FNCSEL_A::_32KHZ_XT)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
pub enum PAD13FNCSEL_A {
    ...
    GPIO13 = 3,
    #[doc = "4: Configure as the SPI channel 3 nCE signal from IOMSTR2"]
    M2NCE3 = 4,
...
impl PAD13FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD13FNCSEL_A {
        match self.bits {
            ...
            1 => PAD13FNCSEL_A::M1NCE1,
            2 => PAD13FNCSEL_A::TCTB0,
            3 => PAD13FNCSEL_A::GPIO13,
            4 => PAD13FNCSEL_A::M2NCE3,
...
impl<'a> PAD13FNCSEL_W<'a> {
    ...
    pub fn m2n_ce3(self) -> &'a mut W {
        self.variant(PAD13FNCSEL_A::M2NCE3)
    }
...
pub enum PAD12FNCSEL_A {
    ...
    GPIO12 = 3,
    #[doc = "4: Configure as CLKOUT signal"]
    CLKOUT = 4,
    #[doc = "5: Configure as the PDM CLK output signal"]
    PDM_CLK = 5,
...
impl PAD12FNCSEL_R {
    ...
    pub fn variant(&self) -> PAD12FNCSEL_A {
        match self.bits {
            ...
            4 => PAD12FNCSEL_A::CLKOUT,
            5 => PAD12FNCSEL_A::PDM_CLK,
...
impl<'a> PAD12FNCSEL_W<'a> {
    ...
    #[doc = "Configure as CLKOUT signal"]
    #[inline(always)]
    pub fn clkout(self) -> &'a mut W {
        self.variant(PAD12FNCSEL_A::CLKOUT)
    }
    #[doc = "Configure as the PDM CLK output signal"]
    #[inline(always)]
    pub fn pdm_clk(self) -> &'a mut W {
        self.variant(PAD12FNCSEL_A::PDM_CLK)
    }
