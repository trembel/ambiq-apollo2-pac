...
pub enum PAD7FNCSEL_A {
    ...
    GPIO7 = 3,
    #[doc = "4: Configure as the ADC Trigger 0 signal"]
    TRIG0 = 4,
    #[doc = "5: Configure as the UART0 TX output signal"]
    UART0TX = 5,
    #[doc = "6: Configure as the IOMSTR0 SPI 3-wire MOSI/MISO loopback signal from IOSLAVE"]
    SLWIR3LB = 6,
    #[doc = "7: Configure as the SPI channel 1 nCE signal from IOMSTR1"]
    M1NCE1 = 7,
}
...
impl PAD7FNCSEL_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> PAD7FNCSEL_A {
        match self.bits {
            0 => PAD7FNCSEL_A::M0WIR3,
            1 => PAD7FNCSEL_A::M0MOSI,
            2 => PAD7FNCSEL_A::CLKOUT,
            3 => PAD7FNCSEL_A::GPIO7,
            4 => PAD7FNCSEL_A::TRIG0,
            5 => PAD7FNCSEL_A::UART0TX,
            6 => PAD7FNCSEL_A::SLWIR3LB,
            7 => PAD7FNCSEL_A::M1NCE1,
            _ => unreachable!(),
        }
    }
...
pub enum PAD6FNCSEL_A {
    ...
    M0MISO = 1,
    #[doc = "2: Configure as the UART0 CTS input signal"]
    UA0CTS = 2,
    #[doc = "3: Configure as GPIO6"]
    GPIO6 = 3,
    #[doc = "4: Configure as the IOMSTR0 SPI MISO loopback signal from IOSLAVE"]
    SLMISOLB = 4,
    #[doc = "5: Configure as the SPI channel 0 nCE signal from IOMSTR1"]
    M1NCE0 = 5,
...
impl PAD6FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD6FNCSEL_A {
        match self.bits {
            0 => PAD6FNCSEL_A::M0SDA,
            1 => PAD6FNCSEL_A::M0MISO,
            2 => PAD6FNCSEL_A::UA0CTS,
            3 => PAD6FNCSEL_A::GPIO6,
            4 => PAD6FNCSEL_A::SLMISOLB,
            5 => PAD6FNCSEL_A::M1NCE0,
            6 => PAD6FNCSEL_A::SLSDALB,
            7 => PAD6FNCSEL_A::I2S_DAT,
            _ => unreachable!(),
        }
    }
...
impl PAD5FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD5FNCSEL_A {
        match self.bits {
            0 => PAD5FNCSEL_A::M0SCL,
            1 => PAD5FNCSEL_A::M0SCK,
            2 => PAD5FNCSEL_A::UA0RTS,
            3 => PAD5FNCSEL_A::GPIO5,
            4 => PAD5FNCSEL_A::M0SCKLB,
            5 => PAD5FNCSEL_A::EXTHFA,
            6 => PAD5FNCSEL_A::M0SCLLB,
            7 => PAD5FNCSEL_A::M1NCE2,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `M0SCKLB`"]
    #[inline(always)]
    pub fn is_m0scklb(&self) -> bool {
        *self == PAD5FNCSEL_A::M0SCKLB
    }
    ...
    #[doc = "Checks if the value of the field is `M0SCLLB`"]
    #[inline(always)]
    pub fn is_m0scllb(&self) -> bool {
        *self == PAD5FNCSEL_A::M0SCLLB
    }
    #[doc = "Checks if the value of the field is `M1NCE2`"]
    #[inline(always)]
    pub fn is_m1n_ce2(&self) -> bool {
        *self == PAD5FNCSEL_A::M1NCE2
    }
}
...
impl<'a> PAD5FNCSEL_W<'a> {
    ...
    #[inline(always)]
    pub fn m0scklb(self) -> &'a mut W {
        self.variant(PAD5FNCSEL_A::M0SCKLB)
    }
    #[doc = "Configure as the External HFA input clock"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn m0scllb(self) -> &'a mut W {
        self.variant(PAD5FNCSEL_A::M0SCLLB)
    }
    #[doc = "Configure as the SPI Channel 2 nCE signal from IOMSTR1"]
    #[inline(always)]
    pub fn m1n_ce2(self) -> &'a mut W {
        self.variant(PAD5FNCSEL_A::M1NCE2)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PAD4PWRDN_A {
    #[doc = "0: Power switch disabled"]
    DIS = 0,
    #[doc = "1: Power switch enabled (switch to GND)"]
    EN = 1,
}
impl From<PAD4PWRDN_A> for bool {
    #[inline(always)]
    fn from(variant: PAD4PWRDN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PAD4PWRDN`"]
pub type PAD4PWRDN_R = crate::R<bool, PAD4PWRDN_A>;
impl PAD4PWRDN_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD4PWRDN_A {
        match self.bits {
            false => PAD4PWRDN_A::DIS,
            true => PAD4PWRDN_A::EN,
        }
    }
    #[doc = "Checks if the value of the field is `DIS`"]
...
#[doc = "Write proxy for field `PAD4PWRDN`"]
pub struct PAD4PWRDN_W<'a> {
    w: &'a mut W,
}
impl<'a> PAD4PWRDN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PAD4PWRDN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(PAD4PWRDN_A::DIS)
    }
    #[doc = "Power switch enabled (switch to GND)"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(PAD4PWRDN_A::EN)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub enum PAD4FNCSEL_A {
    #[doc = "0: Configure as the UART0 CTS input signal"]
    UA0CTS = 0,
    ...
    GPIO4 = 3,
    #[doc = "4: Configure as the IOSLAVE interrupt loopback signal"]
    SLINTGP = 4,
    #[doc = "5: Configure as the SPI channel 5 nCE signal from IOMSTR2"]
    M2NCE5 = 5,
...
impl<'a> PAD4FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the IOSLAVE interrupt loopback signal"]
    #[inline(always)]
    ...
    pub fn m2n_ce5(self) -> &'a mut W {
        self.variant(PAD4FNCSEL_A::M2NCE5)
    }
    #[doc = "Configure as the CLKOUT signal"]
    #[inline(always)]
    pub fn clkout(self) -> &'a mut W {
    ...
    pub fn _32khz_xt(self) -> &'a mut W {
        self.variant(PAD4FNCSEL_A::_32KHZ_XT)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 7 - Pad 4 VSS power switch enable"]
    #[inline(always)]
    pub fn pad4pwrdn(&self) -> PAD4PWRDN_R {
        PAD4PWRDN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - Pad 4 VSS power switch enable"]
    #[inline(always)]
    pub fn pad4pwrdn(&mut self) -> PAD4PWRDN_W {
        PAD4PWRDN_W { w: self }
    }
    #[doc = "Bits 3:5 - Pad 4 function select"]
    #[inline(always)]
