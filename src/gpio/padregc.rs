...
pub enum PAD11FNCSEL_A {
    #[doc = "0: Configure as the analog input for ADC single ended input 2"]
    ADCSE2 = 0,
    ...
    GPIO11 = 3,
    #[doc = "4: Configure as the SPI channel 7 nCE signal from IOMSTR2"]
    M2NCE7 = 4,
    #[doc = "5: Configure as the UART1 CTS input signal"]
    UA1CTS = 5,
    #[doc = "6: Configure as the UART0 RX input signal"]
    UART0RX = 6,
    #[doc = "7: Configure as the PDM Data input signal"]
    PDM_DATA = 7,
}
...
impl<'a> PAD11FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the analog input for ADC single ended input 2"]
    #[inline(always)]
    ...
    pub fn m2n_ce7(self) -> &'a mut W {
        self.variant(PAD11FNCSEL_A::M2NCE7)
    }
    ...
    #[doc = "Configure as the PDM Data input signal"]
    #[inline(always)]
...
pub enum PAD10FNCSEL_A {
    ...
    GPIO10 = 3,
    #[doc = "4: Configure as the SPI channel 6 nCE signal from IOMSTR2"]
    M2NCE6 = 4,
    #[doc = "5: Configure as the UART1 RTS output signal"]
    UA1RTS = 5,
    #[doc = "6: Configure as the SPI channel 4 nCE signal from the IOMSTR4"]
    M4NCE4 = 6,
...
impl PAD10FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD10FNCSEL_A {
        match self.bits {
            0 => PAD10FNCSEL_A::M1WIR3,
            1 => PAD10FNCSEL_A::M1MOSI,
            2 => PAD10FNCSEL_A::M0NCE6,
            3 => PAD10FNCSEL_A::GPIO10,
            4 => PAD10FNCSEL_A::M2NCE6,
            5 => PAD10FNCSEL_A::UA1RTS,
            6 => PAD10FNCSEL_A::M4NCE4,
            7 => PAD10FNCSEL_A::SLWIR3LB,
            _ => unreachable!(),
        }
    }
...
impl<'a> PAD10FNCSEL_W<'a> {
    ...
    pub fn m2n_ce6(self) -> &'a mut W {
        self.variant(PAD10FNCSEL_A::M2NCE6)
    }
...
pub enum PAD9FNCSEL_A {
    ...
    GPIO9 = 3,
    #[doc = "4: Configure as the SPI channel 5 nCE signal from IOMSTR4"]
    M4NCE5 = 4,
    #[doc = "5: Configure as the IOMSTR1 SPI MISO loopback signal from IOSLAVE"]
    SLMISOLB = 5,
    #[doc = "6: Configure as UART1 RX input signal"]
    UART1RX = 6,
...
impl PAD9FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD9FNCSEL_A {
        match self.bits {
            0 => PAD9FNCSEL_A::M1SDA,
            1 => PAD9FNCSEL_A::M1MISO,
            2 => PAD9FNCSEL_A::M0NCE5,
            3 => PAD9FNCSEL_A::GPIO9,
            4 => PAD9FNCSEL_A::M4NCE5,
            5 => PAD9FNCSEL_A::SLMISOLB,
            6 => PAD9FNCSEL_A::UART1RX,
            7 => PAD9FNCSEL_A::SLSDALB,
            _ => unreachable!(),
        }
    }
...
impl<'a> PAD9FNCSEL_W<'a> {
    ...
    pub fn slsdalb(self) -> &'a mut W {
        self.variant(PAD9FNCSEL_A::SLSDALB)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
pub enum PAD8FNCSEL_A {
    ...
    GPIO8 = 3,
    #[doc = "4: Configure as the SPI channel 4 nCE signal from IOMSTR2"]
    M2NCE4 = 4,
    #[doc = "5: Configure as the IOMSTR1 SPI SCK loopback signal from IOSLAVE"]
    M1SCKLB = 5,
    #[doc = "6: Configure as the UART1 TX output signal"]
    UART1TX = 6,
...
impl PAD8FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PAD8FNCSEL_A {
        match self.bits {
            0 => PAD8FNCSEL_A::M1SCL,
            1 => PAD8FNCSEL_A::M1SCK,
            2 => PAD8FNCSEL_A::M0NCE4,
            3 => PAD8FNCSEL_A::GPIO8,
            4 => PAD8FNCSEL_A::M2NCE4,
            5 => PAD8FNCSEL_A::M1SCKLB,
            6 => PAD8FNCSEL_A::UART1TX,
            7 => PAD8FNCSEL_A::M1SCLLB,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_m2n_ce4(&self) -> bool {
        *self == PAD8FNCSEL_A::M2NCE4
    }
    #[doc = "Checks if the value of the field is `M1SCKLB`"]
    #[inline(always)]
    pub fn is_m1scklb(&self) -> bool {
        *self == PAD8FNCSEL_A::M1SCKLB
    }
    ...
    #[doc = "Checks if the value of the field is `M1SCLLB`"]
    #[inline(always)]
    pub fn is_m1scllb(&self) -> bool {
        *self == PAD8FNCSEL_A::M1SCLLB
    }
}
...
impl<'a> PAD8FNCSEL_W<'a> {
    ...
    pub fn m2n_ce4(self) -> &'a mut W {
        self.variant(PAD8FNCSEL_A::M2NCE4)
    }
    #[doc = "Configure as the IOMSTR1 SPI SCK loopback signal from IOSLAVE"]
    #[inline(always)]
    pub fn m1scklb(self) -> &'a mut W {
        self.variant(PAD8FNCSEL_A::M1SCKLB)
    }
    ...
    #[inline(always)]
    pub fn m1scllb(self) -> &'a mut W {
        self.variant(PAD8FNCSEL_A::M1SCLLB)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
