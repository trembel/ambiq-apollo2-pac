...
impl From<HFADJ_GAIN_A> for u8 {
    #[inline(always)]
    fn from(variant: HFADJ_GAIN_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `HFADJ_GAIN`"]
pub type HFADJ_GAIN_R = crate::R<u8, HFADJ_GAIN_A>;
impl HFADJ_GAIN_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, HFADJ_GAIN_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(HFADJ_GAIN_A::GAIN_OF_1),
            1 => Val(HFADJ_GAIN_A::GAIN_OF_1_IN_2),
            2 => Val(HFADJ_GAIN_A::GAIN_OF_1_IN_4),
            3 => Val(HFADJ_GAIN_A::GAIN_OF_1_IN_8),
            4 => Val(HFADJ_GAIN_A::GAIN_OF_1_IN_16),
            5 => Val(HFADJ_GAIN_A::GAIN_OF_1_IN_32),
            i => Res(i),
        }
    }
...
impl R {
    ...
    #[inline(always)]
    pub fn hfadj_gain(&self) -> HFADJ_GAIN_R {
        HFADJ_GAIN_R::new(((self.bits >> 21) & 0x07) as u8)
    }
...
impl W {
    #[doc = "Bits 21:23 - Gain control for HFRC adjustment"]
    #[inline(always)]
    pub fn hfadj_gain(&mut self) -> HFADJ_GAIN_W {
        HFADJ_GAIN_W { w: self }
    }
    #[doc = "Bit 20 - XT warmup period for HFRC adjustment"]
    #[inline(always)]
