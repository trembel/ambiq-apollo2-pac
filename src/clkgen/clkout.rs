...
#[doc = "CLKOUT signal select. Note that HIGH_DRIVE should be selected if any high frequencies (such as from HFRC) are selected for CLKOUT.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum CKSEL_A {
    #[doc = "0: LFRC"]
...
impl CKSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, CKSEL_A> {
        ...
        match self.bits {
            ...
            25 => Val(CKSEL_A::HFRC),
            26 => Val(CKSEL_A::HFRC_DIV4),
            27 => Val(CKSEL_A::HFRC_DIV8),
            28 => Val(CKSEL_A::HFRC_DIV16),
            29 => Val(CKSEL_A::HFRC_DIV64),
            30 => Val(CKSEL_A::HFRC_DIV128),
            31 => Val(CKSEL_A::HFRC_DIV256),
            32 => Val(CKSEL_A::HFRC_DIV512),
...
impl R {
    ...
    #[doc = "Bits 0:5 - CLKOUT signal select. Note that HIGH_DRIVE should be selected if any high frequencies (such as from HFRC) are selected for CLKOUT."]
    #[inline(always)]
